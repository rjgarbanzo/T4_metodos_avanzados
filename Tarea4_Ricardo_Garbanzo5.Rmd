---
title: "Tarea4_Ricardo_Garbanzo5"
...
La variable que queremos predecir es chd que es un indicador de muerte coronaria basado en algunas variables predictivas (factores de riesgo) como son el fumado, la obesidad, las bebidas alcoholicas, entre otras. Las variables son:


a) Usando Bosques Aleatorios (train.randomForest(...) del paquete traineR) para la tabla SAheart.csv con el 80% de los datos para la tabla aprendizaje y un 20% para la tabla testing determine la mejor Probabilidad de Corte, de forma tal que se prediga de la mejor manera posible la categorıa Si de la variable chd, pero sin desmejorar de manera significativa la precision global.
...
# El mejor corte es usando la probabilidad de 0.15, ya que se obtiene un 73% de si y una precision global de 68%, el cual se encuentra por arriba de las otras probabilidades
